[![Build Status](https://travis-ci.org/PatouCaramel/js-training.svg?branch=master)](https://travis-ci.org/PatouCaramel/js-training)
## Setup
First, [**fork**](https://github.com/PatouCaramel/js-training/fork?fragment=1) this repository.
